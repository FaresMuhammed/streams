                ...
                <div className="center flex-wrap p-3 col-12 col-lg-5 shadow rounded" style={{ color: "#EDEDED" }}>
                    <div>
                        ...
                        />
                            ...
                            <p style={{color :'#060606'}}>Double-horsehead pumping unit is based on the model of conventional type. It adopts special curve beam arm. It is one of the ten energy conservation pumping unit that China National Petrochemical Corp recommends.</p>
                    </div>
