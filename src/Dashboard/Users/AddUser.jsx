...
export default function Adduser() {
    ...
    async function Handlesubmit(e) {
        ...
        e.preventDefault()
        await axios
        .post('http://backend.slsog.com/api/users' , 
            {name: Upadateform.Name , email: Upadateform.Email , phone: Upadateform.Phone, company: Upadateform.Company , password: Upadateform.Password , password_confirmation: Upadateform.PasswordConfirm , role: Upadateform.Role } ,
