...
export default function Addjob() {
    ...
    async function Handlesubmit(e) {
        ...
        e.preventDefault()
        await axios
        .post('http://backend.slsog.com/api/jobs' , 
            {title: Upadateform.title , category: Upadateform.category , description: Upadateform.description } ,
            ...
            <>
                ...
                <Form onSubmit={Handlesubmit} className='bg-white w-100 mx-2 p-3'>
                    ...
                    <Form.Group className="mb-3" controlId="formBasicEmailll">
                        ...
                        <Form.Control type="text" placeholder="Enter categoery"
                        name='category'
...
{/* 
                    ...
                    <ReactQuill theme="snow" value={Upadateform.description} onChange={Onchange} />


                    <Button disabled={Upadateform.title.length > 1 && Upadateform.category.length > 1 && Upadateform.description.length > 6 ? false : true } className='center mt-3' variant="primary" type="submit">
                        Add
                    </Button>
